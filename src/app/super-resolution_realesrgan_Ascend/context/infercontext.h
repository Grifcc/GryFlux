...
public:
    ...
    const aclmdlIODims& getOutputDims(size_t index) const { return output_buffers_[index].dims; }
    aclFormat getOutputFormat(size_t index) const { return output_buffers_[index].format; }
    aclDataType getOutputDataType(size_t index) const { return output_buffers_[index].data_type; }
